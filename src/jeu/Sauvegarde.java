...
public class Sauvegarde {
    ...
    public static void sauvegarder(Partie partie) throws IOException {
        ...
        writer.newLine();
        writer.write(String.valueOf(partie.getEtat()));
        writer.newLine();
    ...
    public static Partie charger() throws IOException {
        ...
        int etat = Integer.parseInt(reader.readLine().trim());
        ...
        for (l = 0; l < hauteur; l++) {
            for (c = 0; c < largeur; c++) {
                ...
                appliquerMarqueur(cellule, Integer.parseInt(parts[2]));
    ...
    /**
     * Applique un marqueur a une case a partir de son int.
     *
     * @param cellule la case cible
     * @param cible   le marqueur (VIDE, MINE, SUSPECT)
     */
    private static void appliquerMarqueur(Case cellule, int cible) {
